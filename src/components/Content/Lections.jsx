...
return (
  <>
    ...
    <div className="lection_layout">
      ...
      <ul className="list">
                ...
                <li><a className="link-with-favicon" href="https://youtu.be/-hxLmGWavCA?si=BUY1FuSoUl5XO0US&t=155"> Модуль 1. Заняття 1. Основи HTML  (09.01.2024)</a></li>
                <li><a className="link-with-favicon" href="https://youtu.be/6sQHoBA4v-U?si=HxXLObk--hDKvVRc&t=169"> Модуль 1. Заняття 2. Основи HTML  (11.01.2024)</a></li>
                ...
                <li><a className="link-with-favicon" href="https://youtu.be/zWIjiLRm47A?si=H0pZGg-HFmpItFyq&t=148">2.1. Вступ до CSS  (16.01.2024)</a></li>
                <li><a className="link-with-favicon" href="https://youtu.be/b0O3RpWP7gY?si=ujx6XWs8QWxupo9c&t=142">2.2. Вступ до CSS  (18.01.2024)</a></li>
                <li><a className="link-with-favicon" href="https://youtu.be/YGVhP6Xqd24?si=ToEKZlWAdbNwy6Jz&t=158">3.1. Блокова модель. Flexbox  (23.01.2024)</a></li>
                <li><a className="link-with-favicon" href="https://youtu.be/WkMkaCATnog?si=ORPEeWMWgPRe5pM0&t=56">3.2. Блокова модель. Flexbox  (25.01.2024)</a></li>
                ...
                <li><a className="link-with-favicon" href="https://youtu.be/WU3rkYTzji4?si=FuvOyHIkSB5C1xWS&t=71">4.1. Декоративні ефекти  (30.01.2024)</a></li>
                <li><a className="link-with-favicon" href="https://www.youtube.com/watch?v=NJ95wPRcLow&t=87s">4.2. Декоративні ефекти  (02.02.2024)</a></li>
                <li><a className="link-with-favicon" href="https://youtu.be/wWOkMrA4V7g?si=zYgDLGeBBql2rk44&t=168">5.1. Елементи форм. Доступність  (06.02.2024)</a></li>
                <li><a className="link-with-favicon" href="https://www.youtube.com/watch?v=jxh80tH7vJs&t=160s">5.2. Елементи форм. Доступність  (08.02.2024)</a></li>
                ...
                <li><a className="link-with-favicon" href="https://www.youtube.com/watch?v=B_iR4KpnQEU&t=137s">6.1. Адаптивний дизайн  (13.02.2024)</a></li>
                <li><a className="link-with-favicon" href="https://www.youtube.com/watch?v=zHCHvSFY88A&t=182s">6.2. Адаптивний дизайн  (15.02.2024)</a></li>
      ...
      <ul className="list">
    <li>
      <a className="link-with-favicon" href="https://www.youtube.com/watch?v=k6IxRD5BEXY">Модуль 1. Заняття 1. Основи HTML 1</a>
    </li>
    <li>
      <a className="link-with-favicon" href="https://www.youtube.com/watch?v=lKAVnNi9ZCM">Модуль 1. Заняття 2. Основи HTML 2</a>
    </li>
    <li>
      <a className="link-with-favicon" href="https://www.youtube.com/watch?v=bn9yIxt_rtg">Модуль 2. Заняття 3. Основи CSS. Селектори. Колір</a>
    </li>
    <li>
      <a className="link-with-favicon" href="https://www.youtube.com/watch?v=KM5r3qtBdxY">Модуль 2. Заняття 4. Оформлення тексту і шрифти</a>
    </li>
    <li>
      <a className="link-with-favicon" href="https://www.youtube.com/watch?v=_StgByWohXQ">Модуль 3. Заняття 5. Блочна модель</a>
    </li>
    <li>
      <a className="link-with-favicon" href="https://www.youtube.com/watch?v=c32Jb9Ejz4k">Модуль 3. Заняття 6. Flexbox</a>
    </li>
    <li>
      <a className="link-with-favicon" href="https://www.youtube.com/watch?v=VThG4A-4bJQ">Модуль 4. Заняття 7. Фон і декоративні елементи</a>
    </li>
    <li>
      <a className="link-with-favicon" href="https://www.youtube.com/watch?v=GmEY7lL7YXE">Модуль 4. Заняття 8. Векторна графіка</a>
    </li>
    <li>
      <a className="link-with-favicon" href="https://www.youtube.com/watch?v=K_Jxc8VgSIk">Модуль 5. Заняття 9. Позиціоновані елементи</a>
    </li>
    <li>
      <a className="link-with-favicon" href="https://www.youtube.com/watch?v=wGLls08ReMg">Модуль 5. Заняття 10. Переходи та анімація</a>
    </li>
    <li>
      <a className="link-with-favicon" href="https://youtu.be/Ssws6DoJ3oY">Модуль 6. Заняття 11. Розмітка форм</a>
    </li>
    <li>
      <a className="link-with-favicon" href="https://youtu.be/wahf3ZcDxV4">Модуль 6. Заняття 12. Стилізація форм</a>
    </li>
    <li>
      <a className="link-with-favicon" href="https://youtu.be/AjzUOmu6DQs">Модуль 7. Заняття 13. Препроцесор SASS</a>
    </li>
    <li>
      <a className="link-with-favicon" href="https://youtu.be/QPgbG9WtUsI">Модуль 7. Додатковий Заняття 3. БЕМ</a>
    </li>
    <li>
      <a className="link-with-favicon" href="https://youtu.be/t5hlXeln3go">Модуль 8. Заняття 15. Адаптивна верстка. Ч1</a>
    </li>
    <li>
      <a className="link-with-favicon" href="https://youtu.be/Z5lYspOgtrY">Модуль 8. Заняття 15. Адаптивна верстка. Ч2</a>
    </li>
      </ul>
  ...
  <ul className="list">
    ...
    <li>
      <a className="link-with-favicon" href="https://youtu.be/6_60JBxJsrM?si=tv6VCu7B7J0sg7d4&t=464">Модуль 1. Заняття 2. Змінні та типи. Основи функцій [Дмитро Кісліцин] (14.03.2024)</a>
    ...
    <li><a className="link-with-favicon" href="https://www.youtube.com/watch?v=y3XZ8tH5R7I">Blended 11+12 Апельганц (02.06.2024)</a></li>
        ...
        <ul className="list">
    <li><a className="link-with-favicon" href="https://www.youtube.com/watch?v=IXagOIAGaGw">Модуль 1. Заняття 1. Змінні та розгалуження</a></li>
    <li><a className="link-with-favicon" href="https://www.youtube.com/watch?v=6x_r2GUdzck">Модуль 1. Заняття 2. Розгалуження і цикли</a></li>
    <li><a className="link-with-favicon" href="https://www.youtube.com/watch?v=gi-YyrxjXqk">2.1. Масиви</a></li>
    <li><a className="link-with-favicon" href="https://www.youtube.com/watch?v=TkV_O-hsU5w">2.2. Функції</a></li>
    <li><a className="link-with-favicon" href="https://www.youtube.com/watch?v=LP6KAq0-9Ho">3.1. Об'єкти</a></li>
    <li><a className="link-with-favicon" href="https://www.youtube.com/watch?v=4FHukJT_3Rs">3.2. Об'єкти</a></li>
    <li><a className="link-with-favicon" href="https://www.youtube.com/watch?v=hWaC9JcMa_s">4.1. Callback-функції та замикання</a></li>
    <li><a className="link-with-favicon" href="https://www.youtube.com/watch?v=IMhrOZv4Cf4">4.2. Ключове слово this</a></li>
    <li><a className="link-with-favicon" href="https://www.youtube.com/watch?v=KAuJ9H-l8og">Стрілочні функції</a></li>
    <li><a className="link-with-favicon" href="https://www.youtube.com/watch?v=snuVmKJ1gBg">5.1. Прототипне успадкування</a></li>
    <li><a className="link-with-favicon" href="https://www.youtube.com/watch?v=Z-w9kLvu18A">5.2. Класи</a></li>
    <li><a className="link-with-favicon" href="https://www.youtube.com/watch?v=Tn0VcQLhR6g">6.1. Перебираючі методи масивів ч.1</a></li>
    <li><a className="link-with-favicon" href="https://www.youtube.com/watch?v=tJjxVHDQuwQ">6.2. Перебираючі методи масивів ч.2</a></li>
    <li><a className="link-with-favicon" href="https://www.youtube.com/watch?v=w9gWey_cFgo">7.1. Об'єктна модель документа (DOM)</a></li>
    <li><a className="link-with-favicon" href="https://www.youtube.com/watch?v=iAAtYwGp_II">7.2. Події</a></li>
    <li><a className="link-with-favicon" href="https://www.youtube.com/watch?v=vnSnT-Uo8JI">8.1. Делегування подій</a></li>
    <li><a className="link-with-favicon" href="https://www.youtube.com/watch?v=nkkTOpXPt70">8.2. Chatty events та image lazy-loading</a></li>
    <li><a className="link-with-favicon" href="https://www.youtube.com/watch?v=2BDNwhxQ3Fc">9.1. Node.js і npm</a></li>
    <li><a className="link-with-favicon" href="https://www.youtube.com/watch?v=pB_Cr8yPtGg">9.2. Webpack</a></li>
    <li><a className="link-with-favicon" href="https://www.youtube.com/watch?v=w8vKiU0Hhts">10.1. Бібліотеки</a></li>
    <li><a className="link-with-favicon" href="https://www.youtube.com/watch?v=x-Hm2lZcOsM">11.1. Асинхронність: таймери</a></li>
    <li><a className="link-with-favicon" href="https://www.youtube.com/watch?v=DqNRQ0p6m88">11.2. Проміси</a></li>
    <li><a className="link-with-favicon" href="https://www.youtube.com/watch?v=hwLI5XbA140">12.1. HTTP-запити (AJAX)</a></li>
    <li><a className="link-with-favicon" href="https://www.youtube.com/watch?v=hT-Tyasywdo">12.2. REST-пагінація і нескінченний скрол</a></li>
    <li><a className="link-with-favicon" href="https://www.youtube.com/watch?v=gOrMjmz0wZY">13.1. CRUD</a></li>
    <li><a className="link-with-favicon" href="https://www.youtube.com/watch?v=mDdpDG_Flxk">13.2. Асинхронні функції (async/await)</a></li>
</ul>
    ...
    <li><a className="link-with-favicon" href="https://www.youtube.com/watch?v=4bHqcYlxg2E&t=1s&ab_channel=GoIT">Модуль 2. Заняття 2. Методи рядка: slice, toLowerCase, toUpperCase, includes, startsWith, endsWith, indexOf, trim. Задачі на використання методів рядка. Цикли. Цикл for. Інкремент та декремент. Цикл while та  do...while. Задачі на використання циклів. Викоистання debugger. Оператори break та continue.</a></li>
    <li><a className="link-with-favicon" href="https://www.youtube.com/watch?v=FZuKt9BVtB8&ab_channel=GoIT">Модуль 3. Заняття 1. Масиви. Доступ до елеметів масиву (індексація). Перевизначення елементів масиву. Довжина масиву. Передача за посиланням та за значенням. Методи масиву: join, split, slice, concat, indexOf, push\pop. Ітерації по масиво циклами for та for...of. Задачі на використання циклів та методів.</a></li>
    <li><a className="link-with-favicon" href="https://www.youtube.com/watch?v=DMwfPGNVuv8&ab_channel=GoIT">Модуль 3. Заняття 2. Функції. Стурктура та виклик функцій. Псевдомасив arguments. Задачі з перетворенням псевдомасиву на масив. Stack / Scope. Порядок виконання у стеку викликів. </a></li>
    ...
    <li><a className="link-with-favicon" href="https://www.youtube.com/watch?v=U-u3Ija4ij8&ab_channel=GoIT">Модуль-5-1</a></li>
    <li><a className="link-with-favicon" href="https://www.youtube.com/watch?v=YnrLM8vUtMI&ab_channel=GoIT">Модуль-5-2</a></li>
    ...
    <li><a className="link-with-favicon" href="https://www.youtube.com/watch?v=J5np-KMqlk4&ab_channel=GoIT">Модуль-9-2</a></li>
    <li><a className="link-with-favicon" href="https://www.youtube.com/watch?v=5VT0r8x4zFE&ab_channel=GoIT">Модуль-10-1</a></li>
    <li><a className="link-with-favicon" href="https://www.youtube.com/watch?v=zUHcuoaVrT8&ab_channel=GoIT">Модуль-10-2</a></li>
    <li><a className="link-with-favicon" href="https://www.youtube.com/watch?v=g-q2HaVemvc&ab_channel=GoIT">Модуль-11-1</a></li>
    <li><a className="link-with-favicon" href="https://www.youtube.com/watch?v=qhnRXj2lXIY&ab_channel=GoIT">Модуль-11-2</a></li>
    <li><a className="link-with-favicon" href="https://www.youtube.com/watch?v=C7gfFx1PN3o&ab_channel=GoIT">Модуль-12-1</a></li>
    ...
    <li>
        ...
        <a className="link-with-favicon" href="https://youtu.be/wOBSgQA4OyY">Модуль 1. Заняття 2</a>
    </li>
    <li>
        <a className="link-with-favicon" href="https://youtu.be/aSM8QtWcgTs">Модуль 2. Заняття 1</a>
        <a className="link-with-favicon" href="https://youtu.be/PxA1htVp_FI">Модуль 2. Заняття 2</a>
    </li>
    <li>
        <a className="link-with-favicon" href="https://youtu.be/f5UJpUSXbcg">Модуль 3. Заняття 1</a>
        <a className="link-with-favicon" href="https://youtu.be/PWheSreAtOc">Модуль 3. Заняття 2</a>
    </li>
    <li>
        <a className="link-with-favicon" href="https://youtu.be/rkN4YfnifDY">Модуль 4. Заняття 1</a>
        <a className="link-with-favicon" href="https://youtu.be/-RMh_0cAqeo">Модуль 4. Заняття 2</a>
    </li>
    <li>
        <a className="link-with-favicon" href="https://youtu.be/LWjdHidKW4Y">Модуль 5. Заняття 1</a>
        <a className="link-with-favicon" href="https://youtu.be/PKHIb-enqdc">Модуль 5. Заняття 2</a>
    </li>
    <li>
        <a className="link-with-favicon" href="https://youtu.be/VTgT1tHTueY">Модуль 6. Заняття 1</a>
        <a className="link-with-favicon" href="https://youtu.be/ganXqCITpUM">Модуль 6. Заняття 2</a>
    </li>
    <li>
        <a className="link-with-favicon" href="https://youtu.be/xzavWTkMqYs">Модуль 7. Заняття 1</a>
        <a className="link-with-favicon" href="https://youtu.be/Rpyx_751-ws">Модуль 7. Заняття 2</a>
    </li>
    <li>
...
<ul className="list">
    ...
    <li><a className="link-with-favicon" href="https://www.youtube.com/watch?v=TXCOE4khXs0&t">Модуль 2. Заняття 2. Життєвий цикл, useEffect, LocalStorage (04.07.2024)</a></li>
    <li><a className="link-with-favicon" href="https://github.com/DrynkinSergey/FS_104_React/tree/module_02_l2_useEffect/src/components">Модуль 2. Заняття 2. Події. Стан компонента (04.07.2024)</a></li>
    <li><a className="link-with-favicon" href="https://www.youtube.com/watch?v=PkSqWB-Lreg">Модуль 3. Заняття 1. Форми (09.07.2024)</a></li>
    ...
    <li><a className="link-with-favicon" href="https://www.youtube.com/watch?v=tmey76KYutI" >Практика Blended 7+8 Модуль 8. Владислав Роженко (25.08.2024)</a></li>
      ...
      <ul className="list">
        <li><a className="link-with-favicon" href="https://github.com/VovaMelnyk/TS-new">Репозиторій по Тайпскрипту</a></li>
        <li><a className="link-with-favicon" href="https://www.youtube.com/watch?v=aqd9Y0c8l94">Модуль 1. Типізація (15.04.2024)</a></li>
        <li><a className="link-with-favicon" href="https://www.youtube.com/watch?v=efq3Xpk4kAI">Модуль 1. Generic в TypeScript (17.04.2024)</a></li>
        <li><a className="link-with-favicon" href="https://www.youtube.com/watch?v=bbjgot8237Y">Модуль 2. TypeScript в React (22.04.2024)</a></li>
      </ul>

      <h2>Лекції TypeScript від Володимира Мельника (79-й потік)</h2>
      <ul className="list">
         <li ><a className="link-with-favicon" href="https://www.youtube.com/watch?v=V8tefDOdw2w">Ознайомлення з TypeScript: </a></li>
...
<h2 id='node-marchenko'>Лекції Node.js від Даніїла Марченко / Борис Мешков (104-й потік)</h2>
      <ul className="list">
        <li><a className="link-with-favicon" href="https://github.com/danmar66/fson104">Репозиторій Викладача 104-й потік</a></li>
        <li><a className="link-with-favicon" href="https://www.youtube.com/watch?v=J9jnM4fIr-k">Модуль 1. Заняття 1. Марченко (03.09.2024)</a></li>
        <li><a className="link-with-favicon" href="https://www.youtube.com/watch?v=XyHNVVKiV2I">Модуль 1. Заняття 2. Марченко (05.09.2024)</a></li>
...
<h2 id='node-lyamzin'>Лекції Node.js від Богдана Лямзіна (100-й потік)</h2>
      <ul className="list">
        <li><a className="link-with-favicon" href="https://github.com/BogdanLyamzin/Node.js-100">Репозиторій Node.js 100-й потік, Богдан Лямзін</a></li>
