...
return (
  ...
  <ul className="list">
    ...
    <li><a className="link-with-favicon" href="https://www.youtube.com/watch?v=FZuKt9BVtB8&ab_channel=GoIT">Модуль 3. Заняття 1. Масиви. Доступ до елеметів масиву (індексація). Перевизначення елементів масиву. Довжина масиву. Передача за посиланням та за значенням. Методи масиву: join, split, slice, concat, indexOf, push\pop.</a></li>
